...
# ── Validasi: Tahun produksi minimum per model (dari data OTO.com) ─────────────
MODEL_YEAR_RANGE = {
    "2"              : (2009, 2025),
    "3 Series"       : (1993, 2025),
    "5 Series"       : (2003, 2025),
    ...
    "Karimun"        : (2000, 2025),
    "Kijang"         : (1977, 2004),
    "Kijang Innova"  : (2005, 2025),
    "Land Cruiser"   : (1996, 2025),
    "March"          : (2010, 2019),
    "Mirage"         : (2008, 2025),
    "Mobilio"        : (2013, 2025),
    "Outlander Sport": (2012, 2021),
    "Pajero Sport"   : (2009, 2025),
    "Palisade"       : (2021, 2025),
    "Raize"          : (2020, 2025),
    "Rush"           : (2004, 2025),
    "S-Class"        : (1996, 2025),
    "SX4 S Cross"    : (2008, 2025),
    "Santa Fe"       : (2014, 2025),
    "Serena"         : (2009, 2025),
    "Sienta"         : (2016, 2025),
    "Sigra"          : (2016, 2025),
    ...
    "Xpander"        : (2017, 2025),
    "Yaris"          : (2006, 2025),
    "Yaris Cross"    : (2016, 2025),
}

# ── Validasi: Tipe kendaraan yang valid per model (dari data OTO.com) ──────────
MODEL_CAR_TYPES = {
    "2"              : ["Hatchback", "Sedan"],
    "3 Series"       : ["Sedan"],
    "5 Series"       : ["Sedan"],
    ...
    "Avanza Veloz"   : ["MPV"],
    "Ayla"           : ["Hatchback"],
    "BRV"            : ["CrossOver", "Hatchback", "MPV", "SUV"],
    "Baleno"         : ["Hatchback"],
    "Brio"           : ["Hatchback"],
    "C-Class"        : ["Sedan"],
    "CR-V"           : ["CrossOver", "SUV"],
    ...
    "Civic"          : ["Hatchback", "Sedan"],
    "Corolla"        : ["CrossOver", "Sedan"],
    "Creta"          : ["CrossOver", "SUV"],
    "E-Class"        : ["Sedan"],
    "Ertiga"         : ["MPV"],
    "Fortuner"       : ["SUV"],
    ...
    "Grand Livina"   : ["MPV"],
    "HRV"            : ["CrossOver", "SUV"],
    "Harrier"        : ["CrossOver", "SUV"],
    "Ignis"          : ["Hatchback"],
    "Jazz"           : ["CrossOver", "Hatchback", "SUV"],
    "Jimny"          : ["SUV"],
    "Juke"           : ["CrossOver", "Hatchback"],
    "Karimun"        : ["Hatchback"],
    "Kijang"         : ["MPV"],
    "Kijang Innova"  : ["MPV"],
    "Land Cruiser"   : ["SUV"],
    "March"          : ["CrossOver", "Hatchback"],
    "Mirage"         : ["Hatchback"],
    "Mobilio"        : ["MPV", "SUV"],
    "Outlander Sport": ["SUV"],
    "Pajero Sport"   : ["SUV"],
    "Palisade"       : ["SUV"],
    "Raize"          : ["SUV"],
    "Rush"           : ["CrossOver", "MPV", "SUV"],
    "S-Class"        : ["Sedan"],
    "SX4 S Cross"    : ["CrossOver"],
    "Santa Fe"       : ["SUV"],
    "Serena"         : ["MPV"],
    "Sienta"         : ["MPV"],
    "Sigra"          : ["MPV"],
...
# =============================================================================
    ...
    with col1:
        ...
        # ── Validasi Tipe Kendaraan berdasarkan Model ──────────────────────────
        valid_car_types = MODEL_CAR_TYPES.get(model, None)
        if valid_car_types:
            car_type = st.selectbox(
                "Tipe Kendaraan",
                valid_car_types,
                help=f"Tipe kendaraan yang tersedia untuk {model}: {', '.join(valid_car_types)}"
            )
        else:
            all_car_types = sorted(df_ref["car_type"].dropna().unique().tolist()) if df_ref is not None \
                else ["MPV", "SUV", "Sedan", "Hatchback", "CrossOver"]
            car_type = st.selectbox("Tipe Kendaraan", all_car_types)

        # ── Validasi Tahun berdasarkan Model ──────────────────────────────────
        year_min, year_max = MODEL_YEAR_RANGE.get(model, (1990, 2025))
        year = st.number_input(
            "Tahun",
            min_value=year_min,
            max_value=year_max,
            value=min(2020, year_max) if 2020 >= year_min else year_min,
            step=1,
            help=f"{model} diproduksi mulai tahun {year_min}. Rentang valid: {year_min}–{year_max}."
        )
        if year < year_min:
            st.error(f"❌ {model} baru diproduksi mulai tahun {year_min}. Silakan pilih tahun ≥ {year_min}.")
        elif year > year_max:
            st.error(f"❌ Tahun tidak boleh melebihi {year_max}.")
        else:
            st.caption(f"✅ Rentang tahun valid untuk {model}: {year_min}–{year_max}")
